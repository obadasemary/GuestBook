                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>$name</td>
                                    <td>$message</td>
                                    <td><a href='update.php?id=$id' class='btn btn-lg btn-warning'>Update</a></td>
                                    <td><a href='delete.php?id=$id' class='btn btn-lg btn-danger'>Delete</a></td>
                                </tr>
                                </tbody>
                                ";
                                }
